...
public class MapSearchActivity extends AppCompatActivity implements OnItemClickListener {
...
//    private FeedAdapter adapter;
    ...
    public static Intent createStartIntent(Context context, int menuIconLeft, int menuIconCenterX, LatLng currentLatLng) {
        preContext = context;
        ...
        starter.putExtra(CURRENTLATLNG, currentLatLng);
        return starter;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchBack.postDelayed(new Runnable() {
            @Override
            public void run() {
                searchBack.setImageDrawable(ContextCompat.getDrawable(MapSearchActivity.this,
            ...
            public boolean onPreDraw() {
                ...
                showScrim.playTogether(
                        ...
                        ObjectAnimator.ofArgb(
                                ...
                                Color.TRANSPARENT,
                                ContextCompat.getColor(MapSearchActivity.this, R.color.scrim)));
                showScrim.setDuration(6000L);
                showScrim.setInterpolator(AnimationUtils.loadInterpolator(MapSearchActivity.this,
                        android.R.interpolator.linear_out_slow_in));
                showScrim.start();
                return false;
            }
    ...
    private void initSearch() {
        ...
        OnGetPoiSearchResultListener poiListener = new OnGetPoiSearchResultListener() {
            ...
            public void onGetPoiResult(PoiResult poiResult) {
                ...
                Log.e(TAG, "onGetPoiResult: " + allPoi);
//                ((MapActivity) preContext).onGetPoiResult(poiResult);

//                    for (PoiInfo info : allPoi) {
//                        Log.e(TAG, "onGetPoiResult: " + info.name);
//                        Log.e(TAG, "onGetPoiResult: " + info.location.toString());
...
//        mPoiSearch.searchNearby(new PoiNearbySearchOption().keyword("美食").location(currentlatlng).pageNum(10).radius(2000));
    }
    ...
    protected void dismiss() {
        ...
        if (resultsContainer.getHeight() > 0) {
            ...
            closeResults.setInterpolator(AnimationUtils.loadInterpolator(MapSearchActivity.this,
                    android.R.interpolator.fast_out_slow_in));
    ...
    protected void save() {
        ...
        confirmSaveContainer.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver
            ...
            public boolean onPreDraw() {
                ...
                reveal.setInterpolator(AnimationUtils.loadInterpolator(MapSearchActivity.this,
                        android.R.interpolator.fast_out_slow_in));
                reveal.start();
                ...
                revealScrim.setInterpolator(AnimationUtils.loadInterpolator(MapSearchActivity
                ...
                fadeInScrim.setInterpolator(AnimationUtils.loadInterpolator(MapSearchActivity
                        .this, android.R.interpolator.linear_out_slow_in));
                fadeInScrim.start();
                ...
                saveDribbble.animate()
                        ...
                        .translationY(0f)
                        .setDuration(200L)
                        .setInterpolator(AnimationUtils.loadInterpolator(MapSearchActivity.this,
                                android.R.interpolator.linear_out_slow_in));
...
//        setResult(RESULT_CODE_SAVE, saveData);
    ...
    protected void hideSaveConfimation() {
        if (confirmSaveContainer.getVisibility() == View.VISIBLE) {
            ...
            hideConfirmation.setInterpolator(AnimationUtils.loadInterpolator(MapSearchActivity.this,
                    android.R.interpolator.fast_out_slow_in));
...
//            noResults.setText(ssb);
    ...
    private void searchFor(String query) {
        ...
        //// TODO: 2017/1/10 应该传过来location
//        mPoiSearch.searchInCity(new PoiCitySearchOption().city("上海").keyword(query).isReturnAddr(true).pageNum(20));
    }
    ...
    public void onSearchOut(List<PoiInfo> list) {
        if (list != null && list.size() > 0) {
            if (results.getVisibility() != View.VISIBLE) {
                ...
                fab.animate()
                        ...
                        .setStartDelay(800L)
                        .setDuration(300L)
                        .setInterpolator(AnimationUtils.loadInterpolator(MapSearchActivity
                                .this, android.R.interpolator.linear_out_slow_in));
            }
    ...
    public void onItemClick(View itemView, ImageView image, int id) {
        ((MapActivity) preContext).onGetPoiResult(allPoi.get(id));
    }
}
