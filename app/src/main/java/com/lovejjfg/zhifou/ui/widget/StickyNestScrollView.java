 ...
 */
public class StickyNestScrollView extends NestedScrollView {
    ...
    public StickyNestScrollView(Context context) {
        this(context, null);
    }

    public StickyNestScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.scrollViewStyle);
    }

    public StickyNestScrollView(Context context, AttributeSet attrs, int defStyle) {
